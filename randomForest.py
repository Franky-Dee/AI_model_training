...
# Calculate ROC curve and AUC score for each class (OvR strategy)
...
for i, color in zip(range(n_classes), colors):
    plt.plot(fpr[i], tpr[i], color=color, lw=2, label=f'ROC curve (class {model.classes_[i]}) (area = {roc_auc[i]:.2f})')
